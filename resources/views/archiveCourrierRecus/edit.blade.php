...
<section class="content">
  <div class="container-fluid">
    <form method="post" action="{{ route('archiveCourrierRecus.update',$archiveCourrierRecu->id) }}">
      @method('PUT')
      ...
      <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="date" class="form-control" name="date_archivage" value="{{ $archiveCourrierRecu->date_archivage }}"/>
          </div>
          <div class="form-group">
