...
<section class="content">
  <div class="container-fluid">
    <form method="post" action="{{ route('courrierEnvs.update',$courrierEnv->id) }}">
      @method('PUT')
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      <div class="form-group">
          <div class="form-group">
              <label for="cases">Type du courrier :</label>
              <input type="text" class="form-control" name="type_courr" value="{{ $courrierEnv->type_courr }}"/>
          </div>
          <div class="form-group">
              <label for="cases"> Objet:</label>
              <input type="text" class="form-control" name="objet" value="{{ $courrierEnv->objet }}"/>
          </div>
          <div class="form-group">
              <label for="cases">Destination:</label>
              <input type="text" class="form-control" name="destination" value="{{ $courrierEnv->destination }}"/>
          </div>

          <div class="form-group">
              <label for="cases"> Source:</label>
              <input type="text" class="form-control" name="source" value="{{ $courrierEnv->source }}"/>
          </div>

          <div class="form-group">
              <label for="cases">Titre:</label>
              <input type="text" class="form-control" required name="titre" value="{{ $courrierEnv->titre }}"/>
          </div>

          <div class="form-group">
              <label for="cases"> Date :</label>
              <input type="date" class="form-control" name="date" value="{{ $courrierEnv->date }}"/>
          </div>
